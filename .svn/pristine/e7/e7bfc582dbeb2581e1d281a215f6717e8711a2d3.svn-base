<template>
  <div class="orderConfirm-wrap">
      ...
      <div class="buyer c-box" v-show="clickIndex==2">
        <div class="c-nav">
          <div class="nav-item">
            ...
            <div class="right">
              <a
                href="http://api.map.baidu.com/geocoder?address=深圳市罗湖区黄贝岭街道文华大厦西座10楼DE&output=html&src=webapp.baidu.openAPIdemo"
                class="icon-location"
                target="_blank"
              ></a>
            </div>
    ...
    <div class="under-pay">
      ...
      <div class="to-pay-btn" @click="$router.push('/payment')">去支付</div>
    </div>
